          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value: string) => setProfile({ ...profile, primary_crop: value })}
              >
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value: string) => setProfile({ ...profile, crop_stage: value })}
              >
                <SelectTrigger className="w-full text-base py-6">
              ...
              <Popover>
                ...
                <PopoverContent className="w-auto p-0">
                  <Calendar
                    ...
                    onSelect={(date: Date | undefined) => setProfile({ ...profile, sowing_date: date?.toISOString().split('T')[0] || '' })}
                    initialFocus
                  />
                </PopoverContent>
              </Popover>
